...
Rs     = 500;         % desired radius (m) - use (+) for right handed orbit, 
...
% % run trim commands
% [x_trim, u_trim]=compute_trim1('mavsim_trim',P.Vat,gammas,Rs);
% P.u_trim = u_trim;
% P.x_trim = x_trim;
% % P.opti=opti;
...
P.pn0    = 0;  % initial North position
P.pe0    = 0;  % initial East position
P.pd0    = x_trim(3);  %0;  % initial Down position (negative altitude)
